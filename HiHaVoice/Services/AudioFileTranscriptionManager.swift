...
class AudioTranscriptionManager: ObservableObject {
    ...
    private let logger = Logger(subsystem: "be.hiha.voice", category: "AudioTranscriptionManager")
    ...
    func startProcessing(modelContext: ModelContext, engine: HiHaVoiceEngine) {
    ...
    private func processItem(_ item: AudioFileQueueItem, modelContext: ModelContext, engine: HiHaVoiceEngine) async {
