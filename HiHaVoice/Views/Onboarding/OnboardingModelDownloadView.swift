                    ...
                    VStack(spacing: 40) {
                        ...
                        VStack(spacing: 30) {
                            ...
                            VStack(spacing: 12) {
                                ...
                                Text("On télécharge le modèle optimisé pour bien démarrer.")
                                    .font(.body)
                        ...
                        VStack(alignment: .leading, spacing: 16) {
                            ...
                            HStack(spacing: 20) {
                                performanceIndicator(label: "Vitesse", value: turboModel.speed)
                                performanceIndicator(label: "Précision", value: turboModel.accuracy)
        ...
        VStack(alignment: .leading, spacing: 4) {
            ...
            HStack(spacing: 4) {
                ForEach(0..<5) { index in
                    Circle()
                        .fill(Double(index) / 5.0 <= value ? Color.HiHa.sovereignMarine : Color.white.opacity(0.2))
