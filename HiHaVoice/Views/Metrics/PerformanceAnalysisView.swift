...
struct PerformanceAnalysisView: View {
    ...
    private var systemInfoSection: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            HStack(spacing: 12) {
                SystemInfoCard(label: "Appareil", value: PerformanceAnalyzer.getMacModel())
                SystemInfoCard(label: "Processeur", value: PerformanceAnalyzer.getCPUInfo())
                SystemInfoCard(label: "Mémoire", value: PerformanceAnalyzer.getMemoryInfo())
            }
        }
    }
