...
struct StyleConstants {
    ...
    static let cardGradientSelected = LinearGradient( // Selected glass, accent tint extends further
        gradient: Gradient(stops: [
            .init(color: Color.HiHa.sovereignMarine.opacity(0.3), location: 0.0),
            .init(color: Color.HiHa.sovereignMarine.opacity(0.25), location: 0.70), // Accent tint held longer
    ...
    static let cardBorderSelected = LinearGradient(
        gradient: Gradient(colors: [
            Color.HiHa.sovereignMarine.opacity(0.4),
            Color.HiHa.sovereignMarine.opacity(0.2)
        ]),
        startPoint: .topLeading,
        endPoint: .bottomTrailing
    )
    ...
    static let buttonGradient = LinearGradient(
        colors: [Color.HiHa.sovereignMarine, Color.HiHa.sovereignMarine.opacity(0.8)],
        startPoint: .leading,
        endPoint: .trailing
    )
}
