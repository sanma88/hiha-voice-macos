...
class WindowManager: NSObject {
    ...
    private static let mainWindowIdentifier = NSUserInterfaceItemIdentifier("be.hiha.voice.mainWindow")
    private static let onboardingWindowIdentifier = NSUserInterfaceItemIdentifier("be.hiha.voice.onboardingWindow")
    private static let mainWindowAutosaveName = NSWindow.FrameAutosaveName("HiHaVoiceMainWindowFrame")

    private let logger = Logger(subsystem: "be.hiha.voice", category: "WindowManager")
    ...
    func configureOnboardingPanel(_ window: NSWindow) {
        ...
        window.title = "Hi-Ha Voice Onboarding"
