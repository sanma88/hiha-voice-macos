                    ...
                    ScrollView(.vertical, showsIndicators: false) {
                        VStack(spacing: 0) {
                            ...
                            VStack(spacing: 60) {
                                ...
                                // Title and subtitle
                                VStack(spacing: 16) {
                                    Text("Bienvenue dans le futur de l'écriture")
                                    ...
                                    Text("Une nouvelle façon d'écrire")
                            ...
                            if showSecondaryElements {
                                VStack(spacing: 20) {
                                    ...
                                    SkipButton(text: "Passer la visite") {
...
struct TypewriterRoles: View {
    private let roles = [
        "Ton assistant d'écriture",
        "Ton assistant de vibe-coding",
        "Fonctionne partout sur Mac en un clic",
    ...
    var body: some View {
        VStack {
                    ...
                    .foregroundStyle(
                        LinearGradient(
                            colors: [
                                ...
                                Color.HiHa.sovereignMarine.opacity(0.8),
            ...
            .multilineTextAlignment(.center)
            .shadow(color: Color.HiHa.sovereignMarine.opacity(0.5), radius: 15, x: 0, y: 0)
            .padding(.horizontal)
        }
