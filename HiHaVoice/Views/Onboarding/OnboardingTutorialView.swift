...
struct OnboardingTutorialView: View {
                ...
                HStack(spacing: 0) {
                    ...
                    VStack(alignment: .leading, spacing: 40) {
                        ...
                        VStack(alignment: .leading, spacing: 16) {
                            ...
                            Text("Testons ta configuration Hi-Ha Voice.")
                        ...
                        ZStack {
                            ...
                            RoundedRectangle(cornerRadius: 20)
                                ...
                                .overlay(
                                    ...
                                    LinearGradient(
                                        colors: [
                                            Color.HiHa.sovereignMarine.opacity(0.05),
                                ...
                                .shadow(color: Color.HiHa.sovereignMarine.opacity(0.1), radius: 15, x: 0, y: 0)
                            ...
                            if transcribedText.isEmpty {
                                VStack(spacing: 16) {
                                    ...
                                    Text("Clique ici et commence à parler…")
                                        .font(.system(size: 28, weight: .semibold, design: .rounded))
                            ...
                            RoundedRectangle(cornerRadius: 20)
                                .strokeBorder(
                                    LinearGradient(
                                        colors: [
                                            Color.HiHa.sovereignMarine.opacity(isFocused ? 0.4 : 0.1),
                                            Color.HiHa.sovereignMarine.opacity(isFocused ? 0.2 : 0.05)
                                        ],
                                        startPoint: .topLeading,
                                        endPoint: .bottomTrailing
                                    ),
    ...
    private func getInstructionText(for step: Int) -> String {
        switch step {
        case 1: return "Clique dans la zone de texte à droite"
        case 2: return "Appuie sur ton raccourci"
        case 3: return "Dis quelque chose"
        case 4: return "Appuie à nouveau sur ton raccourci"
        default: return ""
        }
    }
    ...
    private func instructionStep(number: Int, text: String) -> some View {
        HStack(spacing: 20) {
            Text("\(number)")
                ...
                .background(Circle().fill(Color.HiHa.sovereignMarine.opacity(0.2)))
                .overlay(
                    Circle()
                        .stroke(Color.HiHa.sovereignMarine.opacity(0.3), lineWidth: 1)
                )
