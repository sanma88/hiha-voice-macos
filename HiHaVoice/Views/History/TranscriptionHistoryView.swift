        ...
        .toolbar {
            ToolbarItemGroup(placement: .navigation) {
                Button(action: { withAnimation { isLeftSidebarVisible.toggle() } }) {
                    Label("Afficher/Masquer la barre latérale", systemImage: "sidebar.left")
                }
            }

            ToolbarItemGroup(placement: .automatic) {
                Button(action: { withAnimation { isRightSidebarVisible.toggle() } }) {
                    Label("Afficher/Masquer l'inspecteur", systemImage: "sidebar.right")
                }
            }
        }
                    ...
                    VStack(spacing: 32) {
                        ...
                        VStack(spacing: 12) {
                            ...
                            Text("Aucune sélection")
                                ...
                                .foregroundColor(.secondary)
                            Text("Sélectionne une transcription pour voir les détails")
                                .font(.system(size: 14))
                                .foregroundColor(.secondary)
                        }
