...
class Recorder: NSObject, ObservableObject {
    ...
    private let logger = Logger(subsystem: "be.hiha.voice", category: "Recorder")
    ...
    private let audioMeterQueue = DispatchQueue(label: "be.hiha.voice.audiometer", qos: .userInteractive)
    /// Dedicated serial queue for hardware setup.
    private let audioSetupQueue = DispatchQueue(label: "be.hiha.voice.audioSetup", qos: .userInitiated)
