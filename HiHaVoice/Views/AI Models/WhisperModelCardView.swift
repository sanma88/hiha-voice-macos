            ...
            if isCurrent {
                ...
                if isWarming {
                    HStack(spacing: 6) {
                        ProgressView()
                            .controlSize(.small)
                        Text("Optimisation du modèle pour ton appareil…")
                            .font(.system(size: 12))
                            .foregroundColor(Color(.secondaryLabelColor))
                    }
                } else {
...
func performanceColor(value: Double) -> Color {
    switch value {
    case 0.8...1.0: return Color.HiHa.auroraCyan
    case 0.6..<0.8: return Color.HiHa.electricViolet
    case 0.4..<0.6: return Color.HiHa.sovereignMarine
    default: return Color.HiHa.signalCoral
    }
}
