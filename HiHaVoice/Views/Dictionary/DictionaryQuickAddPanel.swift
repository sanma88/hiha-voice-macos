...
struct DictionaryQuickAddView: View {
    enum Mode: CaseIterable {
        ...
        var label: String {
            ...
            case .replacement: return "Remplacement de mot"
            }
        }
    ...
    private var vocabularyInput: some View {
        HStack(spacing: 11) {
            ...
            TextField("", text: $wordInput, prompt: Text("ex. Mariano, Hi-Ha").foregroundColor(.secondary))
    ...
    private var replacementInputView: some View {
        VStack(spacing: 8) {
            HStack(spacing: 10) {
                ...
                TextField("", text: $originalInput, prompt: Text("ex. mon email, mon mail").foregroundColor(.secondary))
                    .textFieldStyle(.roundedBorder)
                    .font(.system(size: 14))
            ...
            HStack(spacing: 10) {
                Text("Par")
                    ...
                    .foregroundStyle(.secondary)
                    .frame(width: 56, alignment: .trailing)
                TextField("", text: $replacementInput, prompt: Text("ex. mariano@hi-ha.be").foregroundColor(.secondary))
                    .textFieldStyle(.roundedBorder)
                    .font(.system(size: 14))
