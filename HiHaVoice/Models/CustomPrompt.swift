...
extension CustomPrompt {
        ...
        VStack(spacing: 8) {
            ZStack {
                ...
                RoundedRectangle(cornerRadius: 14)
                    .fill(
                        isSelected
                        ? AnyShapeStyle(LinearGradient.hiHaBrand)
                    ...
                    .shadow(
                        color: isSelected ?
                            Color.HiHa.electricViolet.opacity(0.35) : Color.black.opacity(0.1),
                ...
                Image(systemName: icon)
                    ...
                    .foregroundStyle(
                        LinearGradient(
                            colors: isSelected ?
                                [Color.HiHa.fgOnAccent, Color.HiHa.fgOnAccent.opacity(0.9)] :
                    ...
                    .shadow(
                        color: isSelected ?
                            Color.HiHa.electricViolet.opacity(0.5) : Color.clear,
                        radius: 3
                    )
            }
                    ...
                    if !triggerWords.isEmpty {
                        HStack(spacing: 2) {
                            Image(systemName: "mic.fill")
                                .font(.system(size: 7))
                                .foregroundColor(isSelected ? Color.HiHa.auroraCyan : .secondary.opacity(0.7))
            ...
            if onEdit != nil || onDelete != nil {
                ...
                if let onDelete = onDelete, !isPredefined {
                    Button(role: .destructive) {
                        let alert = NSAlert()
                        alert.messageText = "Supprimer l'assistant ?"
                        alert.informativeText = "Tu es sûr·e de vouloir supprimer l'assistant « \(self.title) » ? Cette action est irréversible."
    ...
    // Static method to create an "Ajouter" button with the same styling as the prompt icons
